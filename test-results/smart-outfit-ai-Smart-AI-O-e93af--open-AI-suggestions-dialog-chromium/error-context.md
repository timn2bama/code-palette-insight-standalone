...
- Name: smart-outfit-ai.spec.ts >> Smart AI Outfit Suggestions >> user can open AI suggestions dialog
- Location: e2e\smart-outfit-ai.spec.ts:10:3
...
Locator: getByRole('button', { name: /Smart AI Outfit Suggestions/i })
Expected: visible
Timeout: 5000ms
